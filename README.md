...
| [Data Cleaning of Netflix dataset](https://github.com/coco995o/Data-Cleaning-and-Visualization-of-Netflix-dataset)  |  Cleaned  Netflix dataset of duplicates, null values, populating fields. Used PowerBi to visualize  most popular genres, countries with the most movies produced, total number of movies on netflix. |
| [Data Cleaning of Hounsing Data]([https://github.com/coco995o/Data-Cleaning-and-Visualization-of-Netflix-dataset](https://github.com/coco995o/Data-Cleaning-and-Visualization-of-Housing-Dataset/blob/main/DataCleaning_HousingData.sql))  |  Cleansing of housing dataset by populating null values, correcting columns, removing unnecessary columns and removing duplicates. Visualization below. |
